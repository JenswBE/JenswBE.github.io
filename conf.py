...
BLOG_AUTHOR = "Jens Willemsens"  # (translatable)
BLOG_TITLE = "Jensw.be"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://jensw.be/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://jensw.be/"
BLOG_EMAIL = "contact@jensw.be"
BLOG_DESCRIPTION = "Portfolio of Jens Willemsens"  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - Powered by         <a target="_blank" href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
